...
const props = defineProps({
    documents: Object, // Changed to Object for Pagination
    filters: Object,
});
...
<template>
    ...
    <div v-if="selectedDoc" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 p-4 sm:p-6 backdrop-blur-sm">
