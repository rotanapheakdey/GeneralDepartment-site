        ...
        <section class="py-20 max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                >
                    ...
                    >
                        <p class="text-xs text-red-500">{{ post.image }}</p>
                        <img
                            v-if="post.image"
                            :src="
                                post.image
                                    ? post.image
                                    : 'https://placehold.co/600x400/002B5B/FFFFFF?text=News+Update'
                            "
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="bg-white">
                                        <span
                                            class="px-3 py-1 bg-slate-100 text-slate-500 rounded-lg text-xs font-medium uppercase"
                                        >
                                            {{
                                                $t(
                                                    `documents.types.${doc.document_type.toLowerCase().replace(" ", "_")}`,
                                                )
                                            }}
                                        </span>
                                    </td>
