        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="md:w-2/3 p-12 flex flex-col justify-center">
                    <h2
                        class="text-3xl font-bold text-slate-900 mb-6 border-b-2 border-gov-gold pb-4"
                    >
                        Director's Welcome
                    </h2>
                    <p
                    ...
                    >
                        "Our mission at the Department of Digital Content is to
                        ensure that every citizen has access to accurate,
                        timely, and secure information. Through digital
                        transformation, we are building a more transparent and
                        connected future for the Ministry."
                    </p>
                    <div>
                        <p class="font-bold text-xl text-gov-blue">
                            Rotana Pheakdey
                        </p>
                        <p
